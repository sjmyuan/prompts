...
A material verdict DISAGREEs → **reinvestigate-with-feedback**: a new research agent (same type, not the original instance) redoes the investigation with the corrected understanding.

## Round 2
### Re-investigation (reinvestigate-with-feedback)
