...
Use 🚫 Blocker when the agent cannot complete the task at all (no capability, missing frontmatter, absent `<when-to-use-this-skill>`). Use 🔴 Major for violations that break the skill in specific but realistic scenarios.
