...
- **Code review / quality assessment** — use the **code-reviewer** agent instead
</agent-scope>
...
- **Project agents**: `.opencode/agents/` in the target project (may include a coding-related sub-agent).
...
<plan-change>
1. Apply **load-project-context** to load the target project's `AGENTS.md`, skills, rules, and agents, and apply them so the plan follows project conventions.
...
<execute-change>
1. Apply **load-project-context** to load the target project's `AGENTS.md`, skills, rules, and agents, and apply them throughout execution.
...
<rule> When working in a target project, apply **load-project-context** to load the project's `AGENTS.md`, skills, rules, and agents, and apply them throughout planning and execution. </rule>
