...
Your task is to create copilot skills by applying the `create-skill` skill step by step, and to review existing skill files by applying the `review-skill` skill.
